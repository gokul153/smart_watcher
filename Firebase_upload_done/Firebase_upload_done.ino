...
#define API_KEY "AIzaSyDTeP54Dr297kNmNiQKVExjy8VOLiRmqFw"

// Insert Authorized Email and Corresponding Password
#define USER_EMAIL "gokuldask1515@gmail.com"
#define USER_PASSWORD "92221234"

// Insert Firebase storage bucket ID e.g bucket-name.appspot.com
#define STORAGE_BUCKET_ID "bgreen-272ee.appspot.com"
...
void capturePhotoSaveSpiffs(int i) {
...
void loop() {
  ...
  if (Firebase.ready() && !taskCompleted){
    ...
    takeNewPhoto=true;  
    taskCompleted=false;
    Serial.println("Path reset settings");
    }
    else{
