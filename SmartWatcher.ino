...
String FIREBASE_HOST = "https://bgreen-272ee-default-rtdb.firebaseio.com";

String FIREBASE_AUTH = "NnMPl7uY48lttWweaRc2V2NVUj4eKkfkbEJe7Bv2";
...
String Photo2Base64() {
    ...
    auto inputLength = sizeof(input2);
   ...
   // char output[base64_enc_len(3)];
    ...
    for (int i=0;i<fb->len;i++) {
     ...
     //char output[base64::encodeLength(inputLength)];
      ...
      base64::encode(input2, inputLength, output);
